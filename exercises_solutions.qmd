...
If you aren't able to do this on your machine, you may want to check out [Google Colab](https://colab.research.google.com/github/ismayc/oreilly-statistical-modeling-and-inference-with-python/blob/main/exercises_solutions.ipynb). It's a free service that allows you to run Jupyter notebooks in the cloud.
