...
# Accousticness coefficient and intercept
print("Intercept:", model.intercept_)
print("Accousticness coefficient:", model.coef_)
```
...
plt.plot(X, y_pred, color='red', linewidth=2, label='Regression Line Prediction');
...
plt.figure(figsize=(10, 2))
plt.scatter(spotify_sample['predicted_prob'], y, alpha=0.5)
...
# Scatter plot: predicted probability vs actual outcome
plt.figure(figsize=(10, 2))
plt.scatter(imdb_movie_sample['predicted_prob'], y, alpha=0.5)
